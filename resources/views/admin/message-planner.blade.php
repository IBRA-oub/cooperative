...
<main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-white min-h-screen transition-all main ">
    ...
    <div class=" h-[10%] w-[90%] bg-white  z-10 md:flex  ml-10">
      ...
      <a  class="mr-10">
      <div class="w-full px-10 border   rounded-lg shadow-lg bg-green-200 shadow-green-200 border-black border-t-2 border-l-2 hover:rounded">
      ...
      <div class="border flex md:grid grid-cols-5 rounded-lg shadow-lg shadow-gray-200 border-black border-t-2 border-l-2 hover:rounded">
    ...
    <div class="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
       <div class="relative flex">
        {{-- _____________audio_________ --}}
          ...
          <input type="text" name="content" placeholder="Write your message!" class="w-full focus:outline-none focus:placeholder-gray-400 text-gray-600 placeholder-gray-600 pl-12 bg-gray-200 rounded-md py-3">
          @foreach ($users as $user)
          @if($user->planner)
          
          <input type="hidden" name="recipent" value="planner">
          @endif
          
          @endforeach
          {{-- ____________ source /emoji.._____________--}}
