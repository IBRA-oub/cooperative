...
<main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-white min-h-screen transition-all main ">
    ...
    <div class=" h-[10%] w-[90%] bg-white  z-10 flex  ml-10">
      ...
      <a  class="">
         ...
         <div class="border flex md:grid grid-cols-5 rounded-lg shadow-lg bg-gray-200 shadow-gray-200 border-black border-t-2 border-l-2 hover:rounded">
         ...
         <div class="flex sm:items-center  py-3 border-b-2 border-gray-200 bg-white">
             <div class="relative flex items-center ">
                 <div class="relative ml-5">
                     ...
                     <div class="w-10 sm:w-16 h-10 sm:h-16 rounded-full bg-purple-300"></div>
                 </div>
                 <div class="flex flex-col leading-tight">
                     <div class="text-2xl mt-1 flex items-center">
                         <span class="text-gray-700 mr-3" id="stockiste1">Stockiste</span>
                     </div>
    ...
    <div class="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
       <div class="relative flex">
          ...
          <input type="hidden" name="recipient" value="stockiste">
