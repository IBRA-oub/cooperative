    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-white min-h-screen transition-all main">
        ...
        <div id="myModal6" class="modal6 ">
            <div class="modal-content6 rounded-lg">
                ...
                <form id="updateForm">
                    <p id="addPubliciter1" class="text-3xl font-bold text-center">ajouter Publiciter</p>
                    <label id="titreAdd" for="heurs" class="block text-black text-sm font-bold mb-2">titre</label>
                    <input class=" border rounded w-full py-2 px-3 text-grey-darker" type="text" name="heurs"
                        id="heurs" placeholder="ghj"><br>
                    <label id="description" for="heurs"
                    ...
                    <textarea class=" border rounded w-full py-2 px-3 text-grey-darker" type="text" name="heurs" id="heurs"
                        placeholder="ghj"></textarea><br>
                    <label id="datePubliciter" for="heurs" class="block text-black text-sm font-bold mb-2">date
                        publiciter</label>
                    <input class=" border rounded w-full py-2 px-3 text-grey-darker" type="date" name="heurs"
                        id="heurs" placeholder="ghj"><br>
                    <label id="picture" for="heurs" class="block text-black text-sm font-bold mb-2">picture</label>
                    <input class=" border rounded w-full py-2 px-3 text-grey-darker" type="file" name="heurs"
                        id="heurs" placeholder="3"><br>
