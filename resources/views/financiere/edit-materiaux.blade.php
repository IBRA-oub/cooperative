       ...
       <div class="absolute top-10 w-72 md:w-full bg-transparent md:pt-10 ml-[14.7%] md:ml-0">
        <div class="container mx-auto py-8">
            <div class="w-80 ml-3  my-10 md:my-0 md:w-[60%] md:mx-auto rounded shadow bg-white" >
                ...
                <div id="EditeProAchat" class="mx-16 py-4 px-8 text-black text-3xl font-bold border-b border-grey-500 text-center">Edit les charges de materiaux
                </div>
                ...
                <form action="{{route('update.materiaux',['id'=>$materiaux->id])}}" method="POST">
                    ...
                    <div class="py-4 px-8">
                        ...
                        <div class="mb-4">
                            <label id="nomProAchEdi" for="nom" class="block text-black text-sm font-bold mb-2">nom </label>
                        ...
                        <div class="mb-4">
                            <label id="quantiterAchEdi" for="quantiter" class="block text-black text-sm font-bold mb-2">Quantiter</label>
                            <input class=" border rounded w-full py-2 px-3 text-grey-darker" type="text"
