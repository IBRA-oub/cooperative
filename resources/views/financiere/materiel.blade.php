...
@section('content')
    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-white min-h-screen transition-all main">
        <div class="hidden  h-screen w-32 bg-white absolute top-0 z-10 md:flex flex-col ">
            ...
            <a class="mt-32">
                <div
                    class="border flex md:grid grid-cols-5 rounded-lg shadow-lg bg-green-200 shadow-emerald-200 border-black border-t-2 border-l-2 hover:rounded">
            ...
            <a href="/financiere-location" class="mt-10">
                <div
                    ...
                    <div class="translate-y-4 pl-8">
                        <Image alt="instagram logo" width="30" height="30"
                            src="https://sahilnetic.xyz/instagram.png" />
                    </div>
            ...
            <a href="/financiere-materiaux" class="mt-10">
                <div
                    class="border flex md:grid grid-cols-5 rounded-lg shadow-lg shadow-rose-200 border-black border-t-2 border-l-2 hover:rounded">
                    <div class="translate-y-4 pl-8">
                        <Image alt="instagram logo" width="30" height="30" src="https://sahilnetic.xyz/css.png" />
                    </div>
                            ...
                            @foreach ($materiels as $materiel)
                                <tr class=" pt-10 sm:pt-0  w-full border-b border-blue-400">
                                    ...
                                    <td class="  text-center flex justify-center ">
                                        <form action="{{ route('materiel.delete', ['id' => $materiel->id]) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
