...
<main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-200 min-h-screen transition-all main">
    <h1 class="text-md md:text-2xl font-bold text-gray-700 ml-[20%] md:ml-10">Information:</h1>
    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-2 gap-6 px-4 py-8">

        <div
        class="flex flex-col justify-center items-center gap-2 border border-dashed border-gray-500 p-4 text-black rounded-md h-32 bg-green-300 ml-9">
    ...
    <div
        class="flex flex-col justify-center items-center gap-2 border border-dashed border-gray-500 p-4 text-black rounded-md h-32 bg-green-300 ">
        <div class="flex gap-2 items-center">
            <span class="font-bold text-4xl">hj</span>
            <svg class="w-8 h-8 opacity-70" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                stroke-width="1.5" stroke="currentColor">
