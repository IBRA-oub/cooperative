...
@section('title', 'edit Electriciter/eau')
                ...
                <div class="container mx-auto py-8">
                    <div class="w-80 ml-3  my-10 md:my-0 md:w-[60%] md:mx-auto rounded shadow bg-white"
                      >
                        ...
                        <div id="editeElecEau"
                            class="mx-16 py-4 px-8 text-black text-3xl font-bold border-b border-grey-500 text-center">Edit les charge
                            Electriciter/Eau
                        </div>
