       ...
       <div class="w-72 md:w-full bg-transparent md:pt-10 ml-[14.7%] md:ml-0">
        <div class="container mx-auto py-8">
            <div class="w-80 ml-3  my-10 md:my-0 md:w-[60%] md:mx-auto rounded shadow" style="background-color: rgba(116, 116, 116, 0.885)">
                ...
                <div id="editeLocation" class="mx-16 py-4 px-8 text-white text-3xl font-bold border-b border-grey-500 text-center">Edit les charges  Location
                </div>
                ...
                <form action="{{route('update.location',['id'=>$location->id])}}" method="POST">
                    ...
                    <div class="py-4 px-8">
                        ...
                        <div class="mb-4">
                            <label id="nomProAchEdi" for="nom" class="block text-white text-sm font-bold mb-2">nom-ville </label>
                        ...
                        <div class="mb-4">
                            <label id="prixAchaEdit" for="prix" class="block text-white text-sm font-bold mb-2">Prix </label>
