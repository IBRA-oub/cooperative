       ...
       <div class="absolute top-10 w-72 md:w-full  md:pt-10 bg-transparent  ml-[14.7%] md:ml-0">
        <div class="container mx-auto py-8">
            <div class="w-80 ml-3  my-10 md:my-0 md:w-[60%] md:mx-auto rounded shadow bg-white">
                ...
                <div id="addLoc" class="mx-16 py-4 px-8 text-black text-3xl font-bold border-b border-grey-500 text-center">Ajouter  les charges de Location
                </div>
                ...
                <form action="{{route('add.location')}}" method="POST">
                    ...
                    <div class="py-4 px-8">
                        ...
                        <div class="mb-4">
                            <label id="nomProAch" for="nom" class="block text-black text-sm font-bold mb-2">nom-ville</label>
