      ...
      <ul class="mb-4 flex flex-col gap-1">
        ...
        <li>
          ...
          <div class="hidden md:flex md:justify-center mt-2">
            ...
            <input type="radio" id="arabicP" name="langue" value="arabicP" class="hidden">
            <label for="arabicP" id="labelarbicP" class="text-sm bg-white border-2 border-red-500 text-red-500 hover:bg-gray-300 rounded-md  cursor-pointer transition-colors duration-300 ease-in-out md:px-5  ">العربية</label>
        
            <input type="radio" id="francaisP" name="langue" value="francaisP" class="hidden">
            <label for="francaisP"  id="labelFranceP" class= " hidden text-sm bg-white border-2 border-blue-500 text-blue-500 hover:bg-gray-300 rounded-md  cursor-pointer transition-colors duration-300 ease-in-out md:px-5 ">Francais</label>
        </div>
        </li>
        
        @if(request()->is('planner-info-stati'))
        <li>
          <a aria-current="page" class="active" href="/planner-info-stati">
            ...
            <button class="middle none font-sans font-bold center transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 rounded-lg bg-gradient-to-tr from-green-600 to-green-400 text-white shadow-md shadow-white hover:shadow-lg hover:shadow-white active:opacity-[0.85] w-full flex items-center gap-4 px-4 capitalize" type="button">
              ...
              <p id="info/stat"  class="hidden md:block antialiased font-sans text-base leading-relaxed text-inherit font-medium capitalize">info/Statistique</p>
            </button>
    ...
    <li>
        <a aria-current="page" class="active" href="/planner-info-stati">
            <button class="middle none font-sans font-bold center transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs  rounded-lg text-white hover:bg-white/10 active:bg-white/30 w-full flex items-center gap-4 px-4 capitalize" type="button">
                ...
                <p id="info/stat1"  class="hidden md:block antialiased font-sans text-base leading-relaxed text-inherit font-medium capitalize">info/Statistique</p>
            </button>
        </a>
    </li>
    @endif
        ...
        @if(request()->is('planner-dashboard'))
    
        <li>
            <a class="" href="/planner-dashboard">
        ...
        @if(request()->is('planner-message'))
        <li>
            <a class="" href="/planner-message">
                <button     class="middle none font-sans font-bold center transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 rounded-lg bg-gradient-to-tr from-green-600 to-green-400 text-white shadow-md shadow-white hover:shadow-lg hover:shadow-white active:opacity-[0.85] w-full flex items-center gap-4 px-4 capitalize"
                type="button">      
