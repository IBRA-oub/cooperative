...
<aside class="w-20 bg-[#31363F] fixed inset-0 z-50  h-100vh md:w-72 e ">
      ...
      <ul class="mb-4 flex flex-col gap-1">
        <li>
          ...
          <div class="hidden md:flex md:justify-center mt-2">
            ...
            <input type="radio" id="arabicS" name="langue" value="arabicS" class="hidden">
            <label for="arabicS" id="labelarbicS" class="text-sm bg-white border-2 border-red-500 text-red-500 hover:bg-gray-300 rounded-md  cursor-pointer transition-colors duration-300 ease-in-out md:px-5  ">العربية</label>
        
            <input type="radio" id="francaisS" name="langue" value="francaisS" class="hidden">
            <label for="francaisS"  id="labelFranceS" class= " hidden text-sm bg-white border-2 border-blue-500 text-blue-500 hover:bg-gray-300 rounded-md  cursor-pointer transition-colors duration-300 ease-in-out md:px-5 ">Francais</label>
        </div>
        </li>
        @if(request()->is('stockiste-info-stati'))
        <li>
          <a aria-current="page" class="active" href="/stockiste-info-stati">
    ...
    @endif
        ...
        @if(request()->is('stockiste-dashboard'))
    
        <li>
            <a class="" href="/stockiste-dashboard">
        ...
        @if(request()->is('stockiste-message'))
        <li>
            <a class="" href="/stockiste-message">
                <button     class="middle none font-sans font-bold center transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 rounded-lg bg-gradient-to-tr from-green-600 to-green-400 text-white shadow-md shadow-white hover:shadow-lg hover:shadow-white active:opacity-[0.85] w-full flex items-center gap-4 px-4 capitalize"
                type="button">      
...
{{-- _________sidebar end__________ --}}
    ...
    <script src="{{asset('js/stockiste.js')}}"></script>
