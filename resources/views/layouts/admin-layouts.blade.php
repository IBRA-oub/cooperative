      ...
      <ul class="mb-4 flex flex-col gap-1">
        ...
        <li>
          ...
          <div class="hidden md:flex md:justify-center mt-2">
            ...
            <label for="arabic" id="labelarbic" class="text-sm bg-white border-2 border-red-500 text-red-500 hover:bg-gray-300 rounded-md  cursor-pointer transition-colors duration-300 ease-in-out md:px-5  ">العربية</label>
        
            <input type="radio" id="francais" name="langue" value="francais" class="hidden">
            <label for="francais"  id="labelFrance" class= " hidden text-sm bg-white border-2 border-blue-500 text-blue-500 hover:bg-gray-300 rounded-md  cursor-pointer transition-colors duration-300 ease-in-out md:px-5 ">Francais</label>
        </div>
        </li>
    ...
    <li>
        <a class="" href="/admin-travailleur">
          ...
          type="button">
              ...
              <p id="Travailleur" class="hidden md:block antialiased font-sans text-base leading-relaxed text-inherit font-medium capitalize">Travailleur</p>
          </button>
        </a>
      </li>
    @else 
    <li>
          <a class="" href="/admin-travailleur">
            <button class="middle none font-sans font-bold center transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs  rounded-lg text-white hover:bg-white/10 active:bg-white/30 w-full flex items-center gap-4 px-4 capitalize" type="button">
                ...
                <p id="Travailleur1"  class="hidden md:block antialiased font-sans text-base leading-relaxed text-inherit font-medium capitalize">Travailleur</p>
            </button>
          </a>
        </li>
        @endif
