...
@section('title', 'stockiste message')
        ...
        <div class="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
            <div class="relative flex">
                ...
                <form action="" class="flex w-full" id="messageForm">
                    ...
                    <button type="submit"
                        class="inline-flex items-center justify-center rounded-lg px-4 py-3 transition duration-500 ease-in-out text-white bg-purple-300 hover:bg-purple-400 focus:outline-none">
